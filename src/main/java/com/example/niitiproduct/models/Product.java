...
//    Set<Promotion> promotionList = new HashSet<>();
    ...
    public Product(Integer id, String name, String short_description, String long_description, String status, Integer category_id, Integer sub_category_id, Integer manufacture_id, Integer display_order, String meta_title, String meta_keyword, String meta_description, String created_at, String created_by, String updated_at, String updated_by, String deleted_at, String deleted_by) {
        this.id = id;
        this.name = name;
